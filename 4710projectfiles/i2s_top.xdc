...
set_property PACKAGE_PIN U9 [get_ports {effectsw[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {effectsw[0]}]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports {effectsw[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {effectsw[1]}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports {effectsw[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {effectsw[2]}]
##Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
#set_property PACKAGE_PIN R6 [get_ports {B[3]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {B[3]}]
##Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
#set_property PACKAGE_PIN R5 [get_ports {psel[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {psel[0]}]
##Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
#set_property PACKAGE_PIN V7 [get_ports {psel[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {psel[1]}]
##Bank = 34, Pin name = IO_L20N_T3_34,						Sch name = SW6
#set_property PACKAGE_PIN V6 [get_ports {psel[2]} ]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {psel[2]}]
...
#set_property PACKAGE_PIN T8 [get_ports {ODATA_LEDS[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {ODATA_LEDS[0]}]
###Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
#set_property PACKAGE_PIN V9 [get_ports {ODATA_LEDS[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {ODATA_LEDS[1]}]
###Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
#set_property PACKAGE_PIN R8 [get_ports {ODATA_LEDS[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {ODATA_LEDS[2]}]
###Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
#set_property PACKAGE_PIN T6 [get_ports {ODATA_LEDS[3]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {ODATA_LEDS[3]}]
###Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = LED4
#set_property PACKAGE_PIN T5 [get_ports {ODATA_LEDS[4]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {ODATA_LEDS[4]}]
##Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LED5
#set_property PACKAGE_PIN T4 [get_ports {ODATA_LEDS[5]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {ODATA_LEDS[5]}]
##Bank = 34, Pin name = IO_L22P_T3_34,						Sch name = LED6
#set_property PACKAGE_PIN U7 [get_ports {ODATA_LEDS[6]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {ODATA_LEDS[6]}]
##Bank = 34, Pin name = IO_L22N_T3_34,						Sch name = LED7
#set_property PACKAGE_PIN U6 [get_ports {ODATA_LEDS[7]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {ODATA_LEDS[7]}]
##Bank = 34, Pin name = IO_L10N_T1_34,						Sch name = LED8
#set_property PACKAGE_PIN V4 [get_ports {ODATA_LEDS[8]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {ODATA_LEDS[8]}]
##Bank = 34, Pin name = IO_L8N_T1_34,						Sch name = LED9
#set_property PACKAGE_PIN U3 [get_ports {ODATA_LEDS[9]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {ODATA_LEDS[9]}]
##Ba#nk = 34, Pin name = IO_L7N_T1_34,						Sch name = LED10
#set_property PACKAGE_PIN V1 [get_ports {ODATA_LEDS[10]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {ODATA_LEDS[10]}]
##Bank = 34, Pin name = IO_L17P_T2_34,						Sch name = LED11
#set_property PACKAGE_PIN R1 [get_ports {ODATA_LEDS[11]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {ODATA_LEDS[11]}]
##Bank = 34, Pin name = IO_L13N_T2_MRCC_34,					Sch name = LED12
#set_property PACKAGE_PIN P5 [get_ports {ODATA_LEDS[12]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {ODATA_LEDS[12]}]
##Bank = 34, Pin name = IO_L7P_T1_34,						Sch name = LED13
#set_property PACKAGE_PIN U1 [get_ports {ODATA_LEDS[13]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {ODATA_LEDS[13]}]
##Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LED14
#set_property PACKAGE_PIN R2 [get_ports {ODATA_LEDS[14]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {ODATA_LEDS[14]}]
##Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
#set_property PACKAGE_PIN P2 [get_ports {ODATA_LEDS[15]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {ODATA_LEDS[15]}]
...
#set_property PACKAGE_PIN L3 [get_ports {DAT_7SEG[6]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {DAT_7SEG[6]}]
#Bank = 34, Pin name = IO_L3N_T0_DQS_34,					Sch name = CB
#set_property PACKAGE_PIN N1 [get_ports {DAT_7SEG[5]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {DAT_7SEG[5]}]
#Bank = 34, Pin name = IO_L6N_T0_VREF_34,					Sch name = CC
#set_property PACKAGE_PIN L5 [get_ports {DAT_7SEG[4]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {DAT_7SEG[4]}]
#Bank = 34, Pin name = IO_L5N_T0_34,						Sch name = CD
#set_property PACKAGE_PIN L4 [get_ports {DAT_7SEG[3]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {DAT_7SEG[3]}]
#Bank = 34, Pin name = IO_L2P_T0_34,						Sch name = CE
#set_property PACKAGE_PIN K3 [get_ports {DAT_7SEG[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {DAT_7SEG[2]}]
#Bank = 34, Pin name = IO_L4N_T0_34,						Sch name = CF
#set_property PACKAGE_PIN M2 [get_ports {DAT_7SEG[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {DAT_7SEG[1]}]
#Bank = 34, Pin name = IO_L6P_T0_34,						Sch name = CG
#set_property PACKAGE_PIN L6 [get_ports {DAT_7SEG[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {DAT_7SEG[0]}]
...
#set_property PACKAGE_PIN N6 [get_ports {AN_7SEG[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {AN_7SEG[0]}]
##Bank = 34, Pin name = IO_L18P_T2_34,						Sch name = AN1
#set_property PACKAGE_PIN M6 [get_ports {AN_7SEG[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {AN_7SEG[1]}]
##Bank = 34, Pin name = IO_L4P_T0_34,						Sch name = AN2
#set_property PACKAGE_PIN M3 [get_ports {AN_7SEG[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {AN_7SEG[2]}]
##Bank = 34, Pin name = IO_L13_T2_MRCC_34,					Sch name = AN3
#set_property PACKAGE_PIN N5 [get_ports {AN_7SEG[3]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {AN_7SEG[3]}]
##Bank = 34, Pin name = IO_L3P_T0_DQS_34,					Sch name = AN4
#set_property PACKAGE_PIN N2 [get_ports {AN_7SEG[4]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {AN_7SEG[4]}]
##Bank = 34, Pin name = IO_L16N_T2_34,						Sch name = AN5
#set_property PACKAGE_PIN N4 [get_ports {AN_7SEG[5]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {AN_7SEG[5]}]
##Bank = 34, Pin name = IO_L1P_T0_34,						Sch name = AN6
#set_property PACKAGE_PIN L1 [get_ports {AN_7SEG[6]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {AN_7SEG[6]}]
##Bank = 34, Pin name = IO_L1N_T034,							Sch name = AN7
#set_property PACKAGE_PIN M1 [get_ports {AN_7SEG[7]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {AN_7SEG[7]}]
...
set_property PACKAGE_PIN B13 [get_ports {mclk[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {mclk[1]}]
##Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
set_property PACKAGE_PIN F14 [get_ports {ws[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ws[1]}]
##Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3
set_property PACKAGE_PIN D17 [get_ports {sclk[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sclk[1]}]
##Bank = 15, Pin name = IO_L16P_T2_A28_15,					Sch name = JA4
set_property PACKAGE_PIN E17 [get_ports {sd_tx}]					
...
#set_property PACKAGE_PIN C15 [get_ports {nCS}]						
...
### from original project file for basys 3 brd
