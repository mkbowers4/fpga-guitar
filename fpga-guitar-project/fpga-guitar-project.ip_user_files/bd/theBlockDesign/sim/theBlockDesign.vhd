...
entity theBlockDesign is
  ...
  attribute CORE_GENERATION_INFO of theBlockDesign : entity is "theBlockDesign,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=theBlockDesign,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=USER,da_clkrst_cnt=1,synth_mode=Global}";
...
architecture STRUCTURE of theBlockDesign is
  ...
  component theBlockDesign_clk_wiz_0_0 is
  port (
    reset : in STD_LOGIC;
  ...
  end component theBlockDesign_clk_wiz_0_0;
...
begin
  ...
  clock_1 <= clock;
  mclk0 <= clk_wiz_0_clk_out1;
  mclk1 <= clk_wiz_0_clk_out1;
...
clk_wiz_0: component theBlockDesign_clk_wiz_0_0
     port map (
      clk_in1 => clock_1,
