...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rotary_encoder is
  ...
  attribute FSM_ENCODED_STATES of \FSM_sequential_STATE_reg[0]\ : label is "a1b1:00,a1b0:01,a0b0:10,a0b1:11";
  attribute FSM_ENCODED_STATES of \FSM_sequential_STATE_reg[1]\ : label is "a1b1:00,a1b0:01,a0b0:10,a0b1:11";
...
\gain_factor_s[3]_i_12\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\gain_factor_s[3]_i_13\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
