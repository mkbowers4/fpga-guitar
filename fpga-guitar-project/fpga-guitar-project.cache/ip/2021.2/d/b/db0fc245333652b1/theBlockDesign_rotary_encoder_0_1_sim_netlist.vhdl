...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rotary_encoder is
  ...
  signal \shiftin_debounce.rot_count_reg\ : STD_LOGIC_VECTOR ( 17 downto 6 );
...
\gain_factor_s[3]_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\gain_factor_s[3]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
\gain_factor_s_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => \FSM_sequential_STATE_reg_n_0_[1]\,
      DI(1) => \FSM_sequential_STATE_reg_n_0_[1]\,
      DI(0) => \FSM_sequential_STATE_reg_n_0_[1]\,
...
\gain_factor_s_reg[3]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => \FSM_sequential_STATE_reg_n_0_[1]\,
      DI(2) => \FSM_sequential_STATE_reg_n_0_[1]\,
      DI(1) => \FSM_sequential_STATE_reg_n_0_[1]\,
      DI(0) => '1',
      ...
      S(3) => \gain_factor_s[3]_i_6_n_0\,
      S(2) => \gain_factor_s[3]_i_7_n_0\,
      S(1) => \gain_factor_s[3]_i_8_n_0\,
      S(0) => \gain_factor_s[3]_i_9_n_0\
    );
...
rot_count0_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(1) => \rot_count0_carry_i_3__0_n_0\,
...
\rot_count0_carry_i_1__0\: unisim.vcomponents.LUT2
    generic map(
      ...
      I1 => \shiftin_debounce.rot_count_reg\(17),
