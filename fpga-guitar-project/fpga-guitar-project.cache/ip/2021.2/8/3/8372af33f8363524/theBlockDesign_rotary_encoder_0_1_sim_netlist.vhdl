...
\gain_factor_s_reg[3]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => \gain_factor_s[3]_i_6_n_0\,
...
\rot_count[0]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\rot_count[0]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFBF"
    )
        port map (
...
\rot_count[0]_i_8\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
