...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_block_design_clk_wiz_0_0_clk_wiz is
  signal clk_100MHz_block_design_clk_wiz_0_0 : STD_LOGIC;
  signal clk_100MHz_block_design_clk_wiz_0_0_en_clk : STD_LOGIC;
  signal clk_11MHz_block_design_clk_wiz_0_0 : STD_LOGIC;
  signal clk_11MHz_block_design_clk_wiz_0_0_en_clk : STD_LOGIC;
...
clkout1_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg1(7),
      CE1 => '0',
      I0 => clk_11MHz_block_design_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_11MHz,
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_11MHz_block_design_clk_wiz_0_0,
      O => clk_11MHz_block_design_clk_wiz_0_0_en_clk
    );
clkout2_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg2(7),
      CE1 => '0',
      I0 => clk_100MHz_block_design_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_100MHz,
...
clkout2_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_100MHz_block_design_clk_wiz_0_0,
      O => clk_100MHz_block_design_clk_wiz_0_0_en_clk
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      CLKOUT0 => clk_11MHz_block_design_clk_wiz_0_0,
      CLKOUT0B => NLW_mmcm_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_100MHz_block_design_clk_wiz_0_0,
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_11MHz_block_design_clk_wiz_0_0_en_clk,
      CE => '1',
      CLR => reset,
      D => \^locked\,
      Q => seq_reg1(0)
...
\seq_reg2_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_100MHz_block_design_clk_wiz_0_0_en_clk,
      CE => '1',
      CLR => reset,
      D => \^locked\,
      Q => seq_reg2(0)
