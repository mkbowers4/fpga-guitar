...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rotary_encoder is
  ...
  signal \rot_count0_carry__0_n_1\ : STD_LOGIC;
  ...
  signal \rot_count0_carry_i_4__0_n_0\ : STD_LOGIC;
  signal rot_count0_carry_i_4_n_0 : STD_LOGIC;
  signal \rot_count0_carry_i_5__0_n_0\ : STD_LOGIC;
  signal rot_count0_carry_i_5_n_0 : STD_LOGIC;
  signal \rot_count0_carry_i_6__0_n_0\ : STD_LOGIC;
  ...
  signal \shiftin_debounce.rot_count_reg\ : STD_LOGIC_VECTOR ( 17 downto 4 );
  ...
  signal \NLW_rot_count0_carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  signal \NLW_rot_count0_carry__0_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_shiftin_debounce.rot_count_reg[16]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_shiftin_debounce.rot_count_reg[16]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  ...
  attribute SOFT_HLUTNM of \gain_factor_s[3]_i_5\ : label is "soft_lutpair0";
...
\gain_factor_s[12]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\gain_factor_s[12]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\gain_factor_s[12]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\gain_factor_s[3]_i_10\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"87"
    )
        port map (
...
\gain_factor_s[3]_i_11\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      I2 => gain_factor_s_reg(9),
      I3 => gain_factor_s_reg(8),
      O => \gain_factor_s[3]_i_11_n_0\
    );
\gain_factor_s[3]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\gain_factor_s[3]_i_4\: unisim.vcomponents.LUT5
    generic map(
      ...
      I4 => \gain_factor_s[3]_i_11_n_0\,
      O => \gain_factor_s[3]_i_4_n_0\
    );
\gain_factor_s[3]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0444"
    )
        port map (
...
\gain_factor_s[3]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      I2 => gain_factor_s_reg(5),
      I3 => gain_factor_s_reg(4),
      O => \gain_factor_s[3]_i_6_n_0\
    );
\gain_factor_s[3]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\gain_factor_s[3]_i_8\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\gain_factor_s[4]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\gain_factor_s[4]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\gain_factor_s[4]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\gain_factor_s[4]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\gain_factor_s[8]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\gain_factor_s[8]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\gain_factor_s[8]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\gain_factor_s[8]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\gain_factor_s_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2 downto 0) => gain_factor_s_reg(14 downto 12),
...
\gain_factor_s_reg[3]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \gain_factor_s[3]_i_7_n_0\,
      S(2) => \gain_factor_s[3]_i_8_n_0\,
      S(1) => \gain_factor_s[3]_i_9_n_0\,
      S(0) => \gain_factor_s[3]_i_10_n_0\
    );
...
\gain_factor_s_reg[4]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => gain_factor_s_reg(7 downto 4),
...
\gain_factor_s_reg[8]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => gain_factor_s_reg(11 downto 8),
...
rot_count0_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => rot_count0_carry_i_1_n_0,
      DI(2) => rot_count0_carry_i_2_n_0,
      DI(1) => '0',
      DI(0) => rot_count0_carry_i_3_n_0,
...
\rot_count0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => \NLW_rot_count0_carry__0_CO_UNCONNECTED\(3),
      CO(2) => \rot_count0_carry__0_n_1\,
      CO(1) => \rot_count0_carry__0_n_2\,
      CO(0) => \rot_count0_carry__0_n_3\,
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => \rot_count0_carry_i_1__0_n_0\,
      DI(1) => \rot_count0_carry_i_2__0_n_0\,
      DI(0) => \rot_count0_carry_i_3__0_n_0\,
      O(3 downto 0) => \NLW_rot_count0_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3) => '0',
      S(2) => \rot_count0_carry_i_4__0_n_0\,
      S(1) => \rot_count0_carry_i_5__0_n_0\,
      S(0) => \rot_count0_carry_i_6__0_n_0\
    );
rot_count0_carry_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\rot_count0_carry_i_1__0\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\rot_count0_carry_i_2__0\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => \shiftin_debounce.rot_count_reg\(15),
      O => \rot_count0_carry_i_2__0_n_0\
    );
rot_count0_carry_i_3: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\rot_count0_carry_i_4__0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\rot_count0_carry_i_5__0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => \shiftin_debounce.rot_count_reg\(15),
      I1 => \shiftin_debounce.rot_count_reg\(14),
      O => \rot_count0_carry_i_5__0_n_0\
    );
...
\rot_count0_carry_i_6__0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\shiftin_debounce.rot_count_reg[16]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 1) => \NLW_shiftin_debounce.rot_count_reg[16]_i_1_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \shiftin_debounce.rot_count_reg[16]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 2) => \NLW_shiftin_debounce.rot_count_reg[16]_i_1_O_UNCONNECTED\(3 downto 2),
      O(1) => \shiftin_debounce.rot_count_reg[16]_i_1_n_6\,
      O(0) => \shiftin_debounce.rot_count_reg[16]_i_1_n_7\,
      S(3 downto 2) => B"00",
      S(1 downto 0) => \shiftin_debounce.rot_count_reg\(17 downto 16)
    );
