...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rotary_encoder is
  ...
  signal \rot_count0__0_carry_i_1_n_0\ : STD_LOGIC;
  signal \rot_count0__0_carry_i_2_n_0\ : STD_LOGIC;
  signal \rot_count0__0_carry_i_3_n_0\ : STD_LOGIC;
  signal \rot_count0__0_carry_i_4_n_0\ : STD_LOGIC;
  signal \rot_count0__0_carry_i_5_n_0\ : STD_LOGIC;
  signal \rot_count0__0_carry_i_6_n_0\ : STD_LOGIC;
  signal \rot_count0__0_carry_i_7_n_0\ : STD_LOGIC;
  signal \rot_count0__0_carry_i_8_n_0\ : STD_LOGIC;
  signal \rot_count0__0_carry_n_0\ : STD_LOGIC;
  signal \rot_count0__0_carry_n_1\ : STD_LOGIC;
  signal \rot_count0__0_carry_n_2\ : STD_LOGIC;
  signal \rot_count0__0_carry_n_3\ : STD_LOGIC;
  signal rot_sclr : STD_LOGIC;
  signal \shiftin_debounce.rot_count[0]_i_3_n_0\ : STD_LOGIC;
  signal \shiftin_debounce.rot_count_reg\ : STD_LOGIC_VECTOR ( 14 downto 6 );
  ...
  signal \NLW_rot_count0__0_carry_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_shiftin_debounce.rot_count_reg[12]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_shiftin_debounce.rot_count_reg[12]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \FSM_sequential_STATE_reg[0]\ : label is "a1b1:00,a0b1:01,a0b0:10,a1b0:11";
  attribute FSM_ENCODED_STATES of \FSM_sequential_STATE_reg[1]\ : label is "a1b1:00,a0b1:01,a0b0:10,a1b0:11";
  ...
  attribute COMPARATOR_THRESHOLD of \rot_count0__0_carry\ : label is 11;
...
\gain_factor_s[12]_i_5\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => gain_factor_s_reg(12),
...
\gain_factor_s[3]_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      I2 => \^led\(1),
      I3 => gain_factor_s_reg(5),
      O => \gain_factor_s[3]_i_10_n_0\
    );
\gain_factor_s[3]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
      I0 => \gain_factor_s[3]_i_8_n_0\,
      I1 => \gain_factor_s[3]_i_9_n_0\,
      I2 => \^led\(3),
      I3 => \^led\(2),
      I4 => gain_factor_s_reg(14),
      I5 => \gain_factor_s[3]_i_10_n_0\,
      O => gtOp
    );
\gain_factor_s[3]_i_4\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\gain_factor_s[3]_i_5\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\gain_factor_s[3]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      I0 => gain_factor_s_reg(8),
      I1 => gain_factor_s_reg(11),
      I2 => gain_factor_s_reg(6),
      I3 => gain_factor_s_reg(9),
      O => \gain_factor_s[3]_i_8_n_0\
    );
\gain_factor_s[3]_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\gain_factor_s_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \gain_factor_s[12]_i_2_n_0\,
      S(2) => \gain_factor_s[12]_i_3_n_0\,
      S(1) => \gain_factor_s[12]_i_4_n_0\,
      S(0) => \gain_factor_s[12]_i_5_n_0\
    );
...
\gain_factor_s_reg[3]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \gain_factor_s[3]_i_4_n_0\,
      S(2) => \gain_factor_s[3]_i_5_n_0\,
      S(1) => \gain_factor_s[3]_i_6_n_0\,
      S(0) => \gain_factor_s[3]_i_7_n_0\
    );
...
\gain_factor_s_reg[4]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \gain_factor_s[4]_i_2_n_0\,
      S(2) => \gain_factor_s[4]_i_3_n_0\,
      S(1) => \gain_factor_s[4]_i_4_n_0\,
      S(0) => \gain_factor_s[4]_i_5_n_0\
    );
...
\gain_factor_s_reg[8]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \gain_factor_s[8]_i_2_n_0\,
      S(2) => \gain_factor_s[8]_i_3_n_0\,
      S(1) => \gain_factor_s[8]_i_4_n_0\,
      S(0) => \gain_factor_s[8]_i_5_n_0\
    );
...
\rot_count0__0_carry\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \rot_count0__0_carry_n_0\,
      CO(2) => \rot_count0__0_carry_n_1\,
      CO(1) => \rot_count0__0_carry_n_2\,
      CO(0) => \rot_count0__0_carry_n_3\,
      CYINIT => \rot_count0__0_carry_i_1_n_0\,
      DI(3) => \rot_count0__0_carry_i_2_n_0\,
      DI(2) => \rot_count0__0_carry_i_3_n_0\,
      DI(1) => \rot_count0__0_carry_i_4_n_0\,
      DI(0) => \rot_count0__0_carry_i_5_n_0\,
      O(3 downto 0) => \NLW_rot_count0__0_carry_O_UNCONNECTED\(3 downto 0),
      S(3) => \shiftin_debounce.rot_count_reg\(14),
      S(2) => \rot_count0__0_carry_i_6_n_0\,
      S(1) => \rot_count0__0_carry_i_7_n_0\,
      S(0) => \rot_count0__0_carry_i_8_n_0\
    );
\rot_count0__0_carry_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
      ...
      O => \rot_count0__0_carry_i_1_n_0\
    );
\rot_count0__0_carry_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => \shiftin_debounce.rot_count_reg\(14),
      O => \rot_count0__0_carry_i_2_n_0\
    );
\rot_count0__0_carry_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      ...
      O => \rot_count0__0_carry_i_3_n_0\
    );
\rot_count0__0_carry_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
      ...
      O => \rot_count0__0_carry_i_4_n_0\
    );
\rot_count0__0_carry_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      ...
      O => \rot_count0__0_carry_i_5_n_0\
    );
\rot_count0__0_carry_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      ...
      O => \rot_count0__0_carry_i_6_n_0\
    );
\rot_count0__0_carry_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      ...
      O => \rot_count0__0_carry_i_7_n_0\
    );
\rot_count0__0_carry_i_8\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\shiftin_debounce.rot_count_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 2) => \NLW_shiftin_debounce.rot_count_reg[12]_i_1_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \shiftin_debounce.rot_count_reg[12]_i_1_n_2\,
      CO(0) => \shiftin_debounce.rot_count_reg[12]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \NLW_shiftin_debounce.rot_count_reg[12]_i_1_O_UNCONNECTED\(3),
      ...
      S(3) => '0',
      S(2 downto 0) => \shiftin_debounce.rot_count_reg\(14 downto 12)
    );
