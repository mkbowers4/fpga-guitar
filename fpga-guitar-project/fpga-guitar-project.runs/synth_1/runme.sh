...
HD_PWD='/home/mike/repos/fpga-guitar/fpga-guitar-project/fpga-guitar-project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log theBlockDesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source theBlockDesign_wrapper.tcl
